""" - Map Vegard to patterns

Implements anduril.taskmanager.v1 patterns for Vegard compatibility.
This allows Vegard to interface with Lattice infrastructure if needed,
...
- EntityState: Similar to Vegard's DroneState but Lattice-formatted
"""
...
class AndurilTask:
    ...
    # Vegard-specific payload in Anduril parameters field
...
class VegardAndurilBridge:
    """
    Bridge between Vegard MVP and Anduril Lattice patterns.
    
    Allows Vegard to use Anduril-compatible task management
    while keeping internal implementation simple.
    """
    ...
    def start_agent_listener(self, agent_id: str, on_task: Callable[["Task"], None]):
        ...
        When tasks arrive, converts to Vegard format and calls on_task.
        """
