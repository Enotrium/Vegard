...
The bridge between a single drone's onboard intelligence and the Syndar fabric.
This is the only module Syndar adds to the Arthedain execution environment.
